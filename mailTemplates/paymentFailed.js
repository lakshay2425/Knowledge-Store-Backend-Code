...
<head>
    ...
    <title>Payment Failed - Knowledge Store</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="template-container">
        ...
        <div class="content">
            ...
            <p>We're sorry, but your payment could not be processed. Don't worry, you can try again!</p>
            ...
            <div class="order-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">₹${attemptedAmount}</span>
                </div>
                <div class="detail-row">
            ...
            <div class="order-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">Pending Payment</span>
                </div>
            </div>
            ...
            <div class="book-list">
                ...
                <div class="book-item">
                    ...
                    <div class="book-price">₹${rentalPrice}/month</div>
                </div>
            </div>
            
            <div class="testing-notice">
                <h4>🧪 Testing Mode Notice</h4>
                <p>This application is currently in testing phase. No actual payment was attempted. This transaction was processed through Razorpay's test mode for demonstration purposes only.</p>
            </div>
            
            <a href="${retryPaymentUrl}" class="cta-button">Retry Payment</a>
            
            <p style="text-align: center; margin-top: 20px; color: #666;">
                Need help? <a href="${supportUrl}" style="color: #667eea; text-decoration: none;">Contact our support team</a>
            </p>
        </div>
        <div class="footer">
            <p>We're here to help if you need assistance!</p>
            <p>Knowledge Store Support Team 🛠️</p>
