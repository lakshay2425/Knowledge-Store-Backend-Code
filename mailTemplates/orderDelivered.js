...
<head>
    ...
    <title>Order Delivered - Knowledge Store</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="template-container">
        <div class="header">
            ...
            <p>Your books have arrived safely</p>
        </div>
        <div class="content">
            ...
            <div class="testing-notice">
                ...
                <p>This application is currently in testing phase. No actual books will be delivered. This is a demonstration of our email notification system.</p>
            </div>
            
            <a href="${websiteUrl}" class="cta-button">Browse More Books</a>
        </div>
        <div class="footer">
